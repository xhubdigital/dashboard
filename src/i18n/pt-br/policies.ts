  ...
  tabs: [
    {
      ...
      content: [
        ...
        {
          title: 'Venda de Produtos Proibidos ou Ilegais',
          paragraphs: [
            {
              body: [
        ...
        {
          title: 'Conteúdo Ofensivo ou Impróprio',
          paragraphs: [
            {
              body: [
        ...
        },
        {
          ...
          paragraphs: [
            {
              body: [
                'Usar indevidamente marcas registradas, obras ou quaisquer sinais distintivos pertencentes a terceiros, acarreta na violação dos Direitos de Propriedade Intelectual, sendo punível de acordo com a legislação nacional pertinente, inclusive a legislação penal.',
                'Aconselhamos que você verifique em sites de registro próprio, incluindo no banco de dados do INPI - Instituto Nacional da Propriedade Industrial, se o termo que deseja utilizar está protegido por terceiros. Neste sentido recomendamos que procure o auxílio de profissionais especializados no assunto de modo a esclarecer eventuais dúvidas.',
                'No caso de violações repetidas ou graves referente ao uso indevido de marcas poderemos suspender ou desativar permanentemente as contas em questão.',
              ],
            },
          ],
        },
    ...
    },
    {
      ...
      content: [
        ...
        {
          title: 'Quais tipos de informações coletamos?',
          paragraphs: [
            {
              body: [
        ...
        {
          title: 'Como utilizamos essas informações?',
          paragraphs: [
            {
              title: 'Promover, melhorar e desenvolver nossos serviços.',
              body: [
                'Podemos usar essas informações coletadas para nos ajudar a desenvolver, oferecer e melhorar os nossos produtos e serviços destinados a você, existentes ou serem criados.',
                'Também poderemos usar suas informações para fins internos, tais como auditoria, análise de dados e pesquisas para aprimorar os produtos, serviços e comunicações com as lojas parceiras, e geração de análises estatísticas com respeito ao uso dos nossos serviços.',
              ],
            },
            {
            ...
            },
            {
              title: 'Marketing',
              body: [
                'Nós poderemos usar suas informações e da sua loja para enviar publicidade, bem como outros materiais promocionais voltados ao marketing de nossos serviços e de novidades para você, o que inclui campanhas digitais (tais como marketing direcionado em redes sociais e notificações push) e não digitais (como divulgação em radiodifusão, outdoors, panfletos, entre outros).',
              ],
            },
          ],
        },
        {
          title: 'Como as informações são armazenadas?',
          paragraphs: [
            {
    ...
    {
      name: 'Produtos Ilícitos ou Proibidos',
      content: [
        {
          title: 'Política de Produtos Ilícitos ou Proibidos',
          paragraphs: [
            {
              body: [
        ...
        },
        {
          ...
          paragraphs: [
            {
              body: [
                '1. Alimentos, bebidas ou refeições que estejam em desacordo com a legislação aplicável.',
                '2. Animais vivos, animais silvestres, fauna ou flora em extinção, proibidas ou com restrição para venda, acessórios destinados a atividades ilícitas ou que possam impor sofrimento aos animais (ex. rinha de galo).',
                '3. Partes de animais – exceto quando destinados à alimentação e vendidos pelo segmento de Mercados.',
                '4. Armas de qualquer gênero, balas e munições, granadas, pólvora, bem como qualquer tipo de produto que possa ser utilizado para fins violentos.',
                '5. Objetos cortantes ou similares - exceto aqueles destinados manifestamente ao uso pessoal (ex. alicate ou tesoura de unhas) vendidos pelo segmento de Farmácia ou às utilidades domésticas (ex. descascador de alimentos ou tesoura) vendidos pelo segmento de Mercados, desde que o estabelecimento seja autorizado pelos órgãos competentes e nos moldes previstos pelas regulações aplicáveis.',
                '6. Bebidas alcoólicas em desacordo com a legislação aplicável (ex. para menores de 18 anos).',
                '7. Cigarros, cigarros eletrônicos, charutos, narguilés, ou quaisquer outros produtos que contenham tabaco ou nicotina em sua composição.',
                '8. Drogas ilícitas ou substâncias que tenham seu uso ou comercialização vedados pela legislação em vigor, incluindo matéria-prima .',
                ...
                '16. Produtos que violem a legislação de propriedade intelectual.',
                '17. Produtos irregulares (ex. itens em recall ou em desconformidade com as normas emitidas pelas autoridades competentes) ou que sejam de uso impróprio para o público que se destinam.',
                '18. Produtos financeiros de quaisquer tipos, como moedas em circulação no Brasil ou no exterior, criptomoedas, cheques, cartões, metais preciosos, crédito, e ações ou títulos.',
                '19. Produtos que sejam utilizados com a finalidade exclusiva de apostas, jogos de azar, jogos de loteria e rifas, incluindo bilhetes e prêmios envolvidos.',
                '20. Produtos que façam apologia ou promovam violência ou discriminação de qualquer tipo (ex. de gênero, de orientação sexual, de raça etc.).',
